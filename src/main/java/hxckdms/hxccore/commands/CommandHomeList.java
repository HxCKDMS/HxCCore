...
public class CommandHomeList extends AbstractSubCommand<CommandHxC> {
    ...
    public void execute(ICommandSender sender, LinkedList<String> args) throws CommandException {
        ...
        int homeAmount = homes.func_150296_c().size();
        int homesPerPage = 7;
        ...
        sender.addChatMessage(ServerTranslationHelper.getTranslation(sender, "commands.home.list.header", page + 1, pages).setChatStyle(new ChatStyle().setColor(EnumChatFormatting.AQUA)));
        LinkedList<String> homeList = new LinkedList<>(homes.func_150296_c());
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, LinkedList<String> args) {
        ...
        int homeAmount = warps.func_150296_c().size();
        int homesPerPage = 7;
        int pages = (int) Math.ceil((float) homeAmount / (float) homesPerPage);
