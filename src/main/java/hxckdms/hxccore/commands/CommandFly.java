    ...
    public void execute(MinecraftServer server, ICommandSender sender, LinkedList<String> args) throws CommandException {
        switch (args.size()) {
            ...
            case 1:
                ...
                sender.sendMessage(ServerTranslationHelper.getTranslation(sender, target.capabilities.allowFlying ? "commands.fly.other.sender.enabled" : "commands.fly.other.sender.disabled", sender.getName()).setStyle(new Style().setColor(TextFormatting.GRAY)));
