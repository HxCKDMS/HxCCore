...
public class CommandExterminate extends AbstractSubCommand<CommandHxC> {
    ...
    public void execute(ICommandSender sender, LinkedList<String> args) throws CommandException {
                ...
                switch (args.size()) {
                    ...
                    default:
                        if (args.contains("hostiles") && (entity instanceof IMob)) {
                            ...
                            entity.setDead();
                            ++entitiesKilled;
                        } else if (args.stream().anyMatch(str -> entity.getCommandSenderName().toLowerCase().contains(str.toLowerCase()))) {
                            entity.setDead();
                            ++entitiesKilled;
                        }
                        break;
        ...
        sender.addChatMessage(ServerTranslationHelper.getTranslation(sender, "commands.exterminate.killed", entitiesKilled).setChatStyle(new ChatStyle().setColor(EnumChatFormatting.BLUE)));
    }
