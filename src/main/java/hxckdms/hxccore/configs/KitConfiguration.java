...
public class KitConfiguration {
    ...
    public static HashMap<String, Kit> kits = new HashMap<String, Kit>() {{
        put("Starter", new Kit(1, new LinkedHashMap<String, Kit.DummyItem>() {{
            ...
            put("minecraft:potion", new Kit.DummyItem(1, 0, "Second Chance", -1, new HashMap<>(), new LinkedHashMap<Integer, Kit.DummyPotionEffect>(){{put(Potion.regeneration.id, new Kit.DummyPotionEffect((byte)4, 100, false, false));put(Potion.heal.id, new Kit.DummyPotionEffect((byte)2, 0, false, false));put(Potion.resistance.id, new Kit.DummyPotionEffect((byte)2, 1000, false, false));put(Potion.fireResistance.id, new Kit.DummyPotionEffect((byte)1, 10000, false, false));}}, new ArrayList<>(), new LinkedList<String>(){{add("Gives you a second chance at life.");}}, new NBTTagCompound()));
        }}));
    }};
}
