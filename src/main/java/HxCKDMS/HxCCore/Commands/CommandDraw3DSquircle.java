...
public class CommandDraw3DSquircle implements ISubCommand {
    @Override
    public String getCommandName() {
        return "Draw3DSquircle";
    }
    ...
    public void handleCommand(ICommandSender sender, String[] args) {
        if(sender instanceof EntityPlayerMP){
            ...
            boolean CanSend = PermissionsHandler.canUseCommand(CommandsConfig.commands.get("Draw3DSquircle"), player);
            ...
            if (CanSend) {
                ...
                WorldHelper.draw3DSquircle(player.worldObj, x, y, z, block, radius, hollow, updateAmount);
