...
public class Config
{
    ...
    public static int HPPer;
    public static int DMPer;
    ...
    public Config(Configuration config)
    {
        ...
        LMPer = config.getInt("LevelsPerBoost", "Features", 1, 1, 2147000000, "This is the number of levels required per boost");
        DMPer = config.getInt("DamagePerBoost", "Features", 1, 1, 2147000000, "This is the damage you deal per boost");
        HPPer = config.getInt("HealthPerBoost", "Features", 1, 1, 2147000000, "This is the amount of health required per boost");
